...
net use T: \\172.20.55.250\TSC-Arquivos\Imagens
net use R: \\172.20.55.250\TSC-Arquivos
net use P: \\172.20.55.250\TSC-Trabin

echo "Criando Mapeamento temporário para Cópia de Softwares..."
net use W: \\172.20.55.250\TSC-ERPs
...
xcopy W:\TSC-Pedido "C:\Program Files (x86)\Trabin-Software\TSC-Pedido\" /E /Y
...
cd W:\
net use W: /delete
net use W: \\172.20.55.250\TSC-Trabin
