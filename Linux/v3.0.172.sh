...
echo "//172.20.55.250/TSC-Arquivos/ /media/TSC-Arquivos/ cifs username=administrador,password=pro@info_jouglard 0 0" >> /etc/fstab
echo "//172.20.55.250/TSC-ERPs/ /media/TSC-ERPs/ cifs username=administrador,password=pro@info_jouglard 0 0" >> /etc/fstab
echo "//172.20.55.250/TSC-Diversos/ /media/TSC-Diversos/ cifs username=administrador,password=pro@info_jouglard 0 0" >> /etc/fstab
echo "//172.20.55.250/TSC-Trabin/ /media/TSC-Trabin/ cifs username=administrador,password=pro@info_jouglard 0 0" >> /etc/fstab
sudo mount -a
...
cp /media/TSC-ERPs/TSC-Pedido/* /opt/Trabin-Software/TSC-Pedido
cp /media/TSC-ERPs/TSC-Pedido/Atalhos_Linux/* /opt/Trabin-Software/TSC-Pedido/Atalhos_Linux
cp /media/TSC-ERPs/TSC-Pedido/Imagens/* /opt/Trabin-Software/TSC-Pedido/Imagens
cp /media/TSC-ERPs/TSC-Pedido/Logs/* /opt/Trabin-Software/TSC-Pedido/Logs
cp /media/TSC-ERPs/TSC-Pedido/REGs/* /opt/Trabin-Software/TSC-Pedido/REGs
cp /media/TSC-ERPs/TSC-Pedido/Controles/* /opt/Trabin-Software/TSC-Pedido/Controles
